...
example_url0 = 'http://oasis.caiso.com/oasisapi/GroupZip?groupid=HASP_LMP_GRP&startdatetime=20130919T07:00-0000&version=1&resultformat=6'
...
for n in range(len(node)):
    while t <= ((e_year-s_year)*12+(e_month-s_month)): # retrieve 10 day period
        ...
        for x,day in enumerate(ds):
            ...
            url_single = single_api_name+'queryname='+queryname+'&'+'startdatetime='+startdatetime+'&'+'enddatetime='+enddatetime+'&'+'version='+str(version)+'&'+'market_run_id='+market_run_id+'&'+'node='+node[n]+'&'+'resultformat='+resultformat 
